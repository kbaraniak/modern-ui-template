            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                ...
                <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                    <div className='max-lg:flex max-lg:flex-col max-lg:justify-center max-lg:items-center'>
                        ...
                        <h3 className="mb-2 text-xl font-bold text-black">CMS</h3>
                        <p className="text-gray-500 max-md:text-center">Installing easy to manage systems, like Wordpress, Joomla</p>
                    </div>
                    <div className='max-lg:flex max-lg:flex-col max-lg:justify-center max-lg:items-center'>
                        <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12">
                            <svg className="w-5 h-5 text-primary-600 lg:w-6 lg:h-6" fill="currentColor" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                        ...
                        <h3 className="mb-2 text-xl font-bold text-black">React</h3>
                        <p className="text-gray-500 max-max-md:text-center">Creating modern web application for multipurpose</p>
                    </div>
                    <div className='max-lg:flex max-lg:flex-col max-lg:justify-center max-lg:items-center'>
                        <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12">
                        ...
                        <h3 className="mb-2 text-xl font-bold text-black">PHP</h3>
                        <p className="text-gray-500 max-md:text-center">Creating legacy apps suppport old browsers</p>
                    </div>
                    <div className='max-lg:flex max-lg:flex-col max-lg:justify-center max-lg:items-center'>
                        <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12">
                        ...
                        <h3 className="mb-2 text-xl font-bold text-black">SEO</h3>
                        <p className="text-gray-500 max-md:text-center">Optimization page for search browsers</p>
                    </div>
                    <div className='max-lg:flex max-lg:flex-col max-lg:justify-center max-lg:items-center'>
                        <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12">
                        ...
                        <h3 className="mb-2 text-xl font-bold text-black">Enterprise Design</h3>
                        <p className="text-gray-500 max-md:text-center">Designing website for future create.</p>
                    </div>
                    <div className='max-lg:flex max-lg:flex-col max-lg:justify-center max-lg:items-center'>
                        <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12">
                        ...
                        <h3 className="mb-2 text-xl font-bold text-black">Domains</h3>
                        <p className="text-gray-500 max-md:text-center">Keep your company’s with custom address to website</p>
                    </div>
                </div>
            </div>
        </section>
