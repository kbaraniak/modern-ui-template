            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                ...
                <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                    <div className='max-lg:flex max-lg:flex-col max-lg:justify-center max-lg:items-center'>
                        ...
                        <p className="text-gray-500">Installing easy to manage systems, like Wordpress, Joomla</p>
                    </div>
                    <div className='max-lg:flex max-lg:flex-col max-lg:justify-center max-lg:items-center'>
                        <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12">
                        ...
                        <p className="text-gray-500">Creating modern web application for multipurpose</p>
                    </div>
                    <div className='max-lg:flex max-lg:flex-col max-lg:justify-center max-lg:items-center'>
                        <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12">
                        ...
                        <p className="text-gray-500">Creating legacy apps suppport old browsers</p>
                    </div>
                    <div className='max-lg:flex max-lg:flex-col max-lg:justify-center max-lg:items-center'>
                        <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12">
                        ...
                        <p className="text-gray-500">Optimization page for search browsers</p>
                    </div>
                    <div className='max-lg:flex max-lg:flex-col max-lg:justify-center max-lg:items-center'>
                        <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12">
                        ...
                        <p className="text-gray-500">Designing website for future create.</p>
                    </div>
                    <div className='max-lg:flex max-lg:flex-col max-lg:justify-center max-lg:items-center'>
                        <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12">
                        ...
                        <p className="text-gray-500">Keep your company’s with custom address to website</p>
                    </div>
                </div>
            </div>
        </section>
